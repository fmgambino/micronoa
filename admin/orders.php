...
<?php // PAGINATION ?>
	...
	<?php if (@$_GET['page'] != 0): ?>
				<a href="orders.php?page=0&amp;status=<?php echo $status; ?>&amp;search=<?php echo @$_GET['search'] ?>">&lt;&lt;</a>
	<?php endif; ?>
	<?php if (@$_GET['page'] - 2 >= 0): ?>
				<a href="orders.php?page=<?php echo @$_GET['page'] - 2 ?>&amp;status=<?php echo $status; ?>&amp;search=<?php echo @$_GET['search'] ?>">&lt;</a>
	<?php endif; ?>
	<?php for ($i = max(@$_GET['page'] - 3, 0); $i < min($limit, max(@$_GET['page'] - 3, 0) + 6); $i++): ?>
				<a href="orders.php?page=<?php echo $i ?>&amp;status=<?php echo $status; ?>&amp;search=<?php echo @$_GET['search'] ?>"><?php echo $i + 1?></a>
	<?php endfor; ?>
	<?php if (@$_GET['page'] + 2 < $limit): ?>
				<a href="orders.php?page=<?php echo @$_GET['page'] + 1 ?>&amp;status=<?php echo $status; ?>&amp;search=<?php echo @$_GET['search'] ?>">&gt;</a>
	<?php endif; ?>
	<?php if (@$_GET['page'] != $limit - 1): ?>
				<a href="orders.php?page=<?php echo $limit - 1?>&amp;status=<?php echo $status; ?>&amp;search=<?php echo @$_GET['search'] ?>">&gt;&gt;</a>
	<?php endif; ?>
			</div>
	<?php endif; ?>
